...
// Aquí van los mensajes manuales
        float f1 = Float.valueOf(valArray[0]);
        float f2 = Float.valueOf(valArray[1]);
        float f3 = Float.valueOf(valArray[2]);
        float f4 = Float.valueOf(valArray[3]);
        float f5 = Float.valueOf(valArray[4]);
        float f6 = Float.valueOf(valArray[5]);
        float f7 = Float.valueOf(valArray[6]);
